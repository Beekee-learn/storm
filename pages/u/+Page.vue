<template>
	<div id="page" v-if="identifiant !== '' && role === 'utilisateur'">
				...
				<div class="section">
					...
					<div id="filtrer">
						<div class="rechercher">
							...
							<input type="search" v-model="requete" :placeholder="$t('rechercher')">
						</div>
						<div class="filtrer">
		...
		<div class="conteneur-modale" role="dialog" tabindex="-1" v-else-if="modale === 'motdepasse'">
			<div id="modale-motdepasse" class="modale" role="document">
				<header>
				...
				<div class="conteneur">
					<div class="contenu">
						...
						<input id="champ-motdepasse-actuel" type="password" maxlength="48" v-model="motDePasse">
						<label for="champ-nouveau-motdepasse">{{ $t('nouveauMotDePasse') }}</label>
						<input id="champ-nouveau-motdepasse" type="password" maxlength="48" v-model="nouveauMotDePasse">
						<label for="champ-confirmation-motdepasse">{{ $t('confirmationNouveauMotDePasse') }}</label>
						<input id="champ-confirmation-motdepasse" type="password" maxlength="48" v-model="confirmationNouveauMotDePasse" @keydown.enter="modifierMotDePasse">
						<div class="actions">
		...
		<div class="conteneur-modale" role="dialog" tabindex="-1" v-else-if="modale === 'creer'">
			<div id="modale-creer" class="modale" role="document">
				<header>
				...
				<div class="conteneur">
					<div class="contenu">
						<label>{{ $t('titre') }}</label>
						<input type="text" v-model="titre" @keydown.enter="creer">
		...
		<div class="conteneur-modale" role="dialog" tabindex="-1" v-else-if="modale === 'importer'">
			<div id="modale-importer" class="modale" role="document">
				<header>
			...
			if (nouveauMotDePasse === confirmationNouveauMotDePasse) {
				...
				axios.post(this.hote + '/api/modifier-mot-de-passe-utilisateur', {
					...
					if (donnees === 'non_connecte') {
						...
						this.message = this.$t('motDePasseModifie')
