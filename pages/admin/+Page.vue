<template>
	<main id="page" v-if="acces">
		<div id="accueil">
			...
			<div id="conteneur">
				...
				<div class="conteneur">
					...
					<input type="text" maxlength="48" v-model="motdepasse">
				</div>
				<div class="actions">
				...
				<div class="conteneur">
					<label>{{ $t('codeInteraction') }}</label>
					<input type="number" v-model="codeM">
				</div>
				<div class="conteneur">
					<label>{{ $t('champ') }}</label>
				...
				<div class="conteneur">
					...
					<input type="text" v-model="valeur" :maxlength="4" v-if="champ === 'motdepasse'">
					<input type="text" v-model="valeur" v-else>
				</div>
				<div class="actions">
				...
				<div class="conteneur">
					<label>{{ $t('codeInteraction') }}</label>
					<input type="number" v-model="codeE">
				</div>
				<div class="actions">
				...
				<div class="conteneur">
					<label>{{ $t('codeInteraction') }}</label>
					<input type="number" v-model="codeS">
				</div>
				<div class="conteneur">
				...
				<div class="conteneur">
					<label>{{ $t('identifiant') }}</label>
					<input type="text" v-model="identifiantS">
				</div>
				<div class="actions">
		...
		<div class="conteneur-modale alerte" role="dialog" tabindex="-1" v-if="modale !== ''">
